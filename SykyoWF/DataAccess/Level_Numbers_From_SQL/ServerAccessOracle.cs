...
namespace WindowsFormsApplication1.BL
{
    ...
    class ServerAccessOracle : ServerAccessInterface
    {
        #region Variables
        // log options model
        DataAccess.Options.LoggingSystemOptions logingOptions;
        ...
        /// Initiate connection
        /// </summary>
        public ServerAccessOracle(DataAccess.Options.LoggingSystemOptions logingOptionsReferince)
        {
        ...
        { 
            ...
            #region LOG
            //=== CUSTOM LOGGER===================================================================================
            LoggingSystem.CodeExplorer.ElementMethod thisMethod = new LoggingSystem.CodeExplorer.ElementMethod();
