...
{
    class SObjectCollection : AbstractCollection
    {
        ...
        internal void AddByName(string lastString, int mode)
        {
            ServerAccessInterface databaseAccess = new ServerAccessMySQL(null);
