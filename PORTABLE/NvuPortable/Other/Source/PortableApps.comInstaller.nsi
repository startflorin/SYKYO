...
!define NAME "Nvu Portable"
!define SHORTNAME "NvuPortable"
!define VERSION "1.0.0.5"
!define FILENAME "Nvu_Portable_1.0_Rev_5_en-us"
!define CHECKRUNNING "NvuPortable.exe"
!define CLOSENAME "Nvu Portable"
!define ADDONSDIRECTORYPRESERVE "App\nvu\plugins"
!define PORTABLEAPPSINSTALLERVERSION "0.9.9.0"
!define INSTALLERCOMMENTS "For additional details, visit PortableApps.com"
!define INSTALLERADDITIONALTRADEMARKS "Nvu is a Trademark of Linspire, Inc. " ;end this entry with a period and a space if used
...
Section "!App Portable (required)"
	...
	RMDir /r "$INSTDIR\Other\NvuPortableSource"
	RMDir /r "$INSTDIR\Other\NvuSource"
