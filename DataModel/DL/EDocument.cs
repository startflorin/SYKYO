...
namespace DataModel.DL.DocumentManager
{
    public class EDocumentConvertor
    {
        ...
        private void GeneratePersistency()
        {
            ...
            SyntaxInterface oracleSyntax = new SyntaxMySQL();
    ...
    public enum SCElementType { AcoladeBracketBlock, AngleBracketBlock, RoundBracketBlock, RightBracketBlock, Undefined };
    
    public class SCodeToken 
    {
