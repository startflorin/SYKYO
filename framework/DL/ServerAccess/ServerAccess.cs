...
namespace DataPersistency.DL.ServerAccess
{
    public class ServerAccess
    {
        ...
        static ServerAccess()
        {
            ...
            try
            {
                try
                {
                    ...
                    if (MySqlTrace) DataPersistency.UI.Logging.SQLView.Log(mySqlCommand.CommandText);
                    while (myReader.Read())
                    {
        ...
        public string getRelationNameByID(int[] a)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(new string[] { nameString });
            return nameString;
        }
        #endregion
        ...
        public int[] getRelationID(string Name)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(relationPosition);
        ...
        internal List<int[]> getAllRelations()
        {
            ...
            if (MyResultsTrace)
            {
                ...
                DataPersistency.UI.Logging.SQLView.LogResult(new string[] { ResultLog });
            }
            return allRelations;
        }
        ...
        internal int CountOccurences(string Name)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(new int[] { symbolPosition });
        ...
        public string getSymbolNameByID(int[] a)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(new string[] { name });
            return name;
        }
        ...
        public int[] getSymbolIDByName(string Name)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(symbolPosition);
            return symbolPosition;
        }
        ...
        internal List<int[]> IsTransitive(List<int[]> result, int[] r, int[] a, int[] b, int limit)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (MySqlTrace) DataPersistency.UI.Logging.SQLView.Log(mySqlCommand2.CommandText);
        ...
        internal int ExistsValues(int[] r, int[] a, int[] b)
        {
            ...
            if (MyResultsTrace) DataPersistency.UI.Logging.SQLView.LogResult(new int[] { relationCount });
            return relationCount;
        }
